                ...
                {!this.props.closing ?
                    <ValidatorForm onSubmit={this.handleSubmit}>
                        ...
                        <div className="difficulty-input recipe-form-input">
                            ...
                            <div className="radio-group-options">
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="difficulty" value={Difficulty.EASY}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.difficulty === Difficulty.EASY}/>
                                    <div className="radio-button-label">Easy</div>
                                </div>
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="difficulty" value={Difficulty.MEDIUM}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.difficulty === Difficulty.MEDIUM}/>
                                    <div className="radio-button-label">Medium</div>
                                </div>
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="difficulty" value={Difficulty.HARD}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.difficulty === Difficulty.HARD}/>
                        ...
                        <div className="food-type-input recipe-form-input">
                            ...
                            <div className="radio-group-options">
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="foodType" value={FoodType.BREAKFAST}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.foodType === FoodType.BREAKFAST}/>
                                    <div className="radio-button-label">Breakfast</div>
                                </div>
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="foodType" value={FoodType.LUNCH}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.foodType === FoodType.LUNCH}/>
                                    <div className="radio-button-label">Lunch</div>
                                </div>
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="foodType" value={FoodType.DINNER}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.foodType === FoodType.DINNER}/>
                                    <div className="radio-button-label">Dinner</div>
                                </div>
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="foodType" value={FoodType.SNACK}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.foodType === FoodType.SNACK}/>
                                    <div className="radio-button-label">Snack</div>
                                </div>
                                <div className="radio-button-option">
                                    <RadioButton color='primary' name="foodType" value={FoodType.DESSERT}
                                                 onChange={this.handleChange}
                                                 checked={this.state.recipe.foodType === FoodType.DESSERT}/>
                        ...
                        <div className="ingredients-input recipe-form-input">
                            ...
                            <div className="input-container">
                                <IngredientInputs ingredients={this.state.recipe.ingredients}
                                                  handleChange={this.handleChange}
                                                  addNewIngredient={this.addNewIngredient}
                                                  removeIngredient={this.removeIngredient}/>
                                <Button type='button' color='primary' onClick={this.addNewIngredient}>+ Add
                                    Ingredient</Button>
                            </div>
                        </div>
                        <div className="instructions-input recipe-form-input">
                            ...
                            <div className="input-container">
                                <StepsInput procedure={this.state.recipe.procedure} handleChange={this.handleChange}
                    ...
                    <div>
                        ...
                        <Button onClick={this.closeDialog}>Yes</Button> <Button
                        onClick={this.props.cancelCloseDialog}>No</Button>
                    </div>
                }
            </div>
        )
