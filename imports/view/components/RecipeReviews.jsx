                    ...
                    <div className="add-new-review">
                        <ValidatorForm onSubmit={this.handleSubmit}>
                            <div className="rating-input">
                                <label
                                    className={Number(this.state.review.rating) >= 5 ? "five-star star-input checked" : "five-star star-input unchecked"}>
                                    <input className="rating-input-circle" type="radio" name="rating" value={5}
                                ...
                                <label
                                    className={Number(this.state.review.rating) >= 4 ? "four-star star-input checked" : "four-star star-input unchecked"}>
                                    <input className="rating-input-circle" type="radio" name="rating" value={4}
                                           onChange={this.handleChange}/>
                                    <Icon className="input-star-icon">star</Icon>
                                    <Icon className="input-star-icon">star</Icon>
                                    <Icon className="input-star-icon">star</Icon>
                                ...
                                <label
                                    className={Number(this.state.review.rating) >= 3 ? "three-star star-input checked" : "three-star star-input unchecked"}>
                                    <input className="rating-input-circle" type="radio" name="rating" value={3}
                                           onChange={this.handleChange}/>
                                    <Icon className="input-star-icon">star</Icon>
                                    <Icon className="input-star-icon">star</Icon>
                                    <Icon className="input-star-icon">star</Icon>
                                ...
                                <label
                                    className={Number(this.state.review.rating) >= 2 ? "two-star star-input checked" : "two-star star-input unchecked"}>
                                    <input className="rating-input-circle" type="radio" name="rating" value={2}
                                           onChange={this.handleChange}/>
                                    <Icon className="input-star-icon">star</Icon>
                                    <Icon className="input-star-icon">star</Icon>
                                </label>
                                <label
                                    className={Number(this.state.review.rating) >= 1 ? "one-star star-input checked" : "one-star star-input unchecked"}>
                                    <input className="rating-input-circle" type="radio" name="rating" value={1}
                                           onChange={this.handleChange}/>
                                    <Icon className="input-star-icon">star</Icon>
                                </label>
                            </div>
                        ...
                        <div className="review-action-buttons">
                            <div className="delete-review review-part">
                                <Tooltip title="Edit Review">
                                    <Icon className="icon-delete-review"
                                          onClick={() => this.handleEditClicked(reviewByUser)}>edit</Icon>
                                </Tooltip>
                            </div>
                            <div className="delete-review review-part">
                                <Tooltip title="Delete Review">
                                    <Icon className="icon-delete-review"
                                          onClick={() => this.handleDeleteClicked(reviewByUser)}>delete_outline</Icon>
                                </Tooltip>
                            </div>
                        </div>
                    </div> : null}
