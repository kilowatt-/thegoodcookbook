            ...
            <div className="login">
                {Meteor.user() ?
                    ...
                    <div className="login-signup">
                        ...
                        <CommonDialog closeDialog={this.closeRegistrationForm} dialogOpen={this.props.signupDialogOpen}
                                      dialogTitle='Sign Up' dialogContent={<RegistrationForm/>}/>
                        <CommonDialog closeDialog={this.closeLoginForm} dialogOpen={this.props.loginDialogOpen}
                                      dialogTitle='Log In' dialogContent={<LoginForm/>}/>
                    </div>
                }
            </div>
        );
