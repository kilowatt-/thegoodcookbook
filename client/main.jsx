...
Meteor.startup(() => {
    ...
    Tracker.autorun(() => {
        ...
        Meteor.subscribe('recipes', {
            onReady: () => {
                store.dispatch(recipeLoadSuccess())
            },
            onError: () => {
                store.dispatch(recipeLoadError(arguments))
            }
        });
        Meteor.subscribe('favourites', {
            onReady: () => {
                store.dispatch(getFavouritesSuccess())
            },
            onError: () => {
                store.dispatch(getFavouritesError(arguments))
            }
        });
